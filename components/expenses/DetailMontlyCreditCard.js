...
const DetailMonthlyCreditCard = ({ item }) => {
  const [isPressed, setIsPressed] = useState(false);
  const { deleteMonthlyCredit, setMonthlyCreditInst, setIsMonthlyExpenseModalVisible } = useContext(ExpenseContext);
  const { deleteMontlyCreditInst } = useSavings();
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            ...
            style: "destructive",
            onPress: () => {
              deleteMonthlyCredit(item.id);
              deleteMontlyCreditInst(item.id)
            },
          },
        ],
        { cancelable: false }
...
export default DetailMonthlyCreditCard;
